...
class Solver {
  ...
  *createDistanceConstraints() {
  ...
  /**
   * Make sure points are no further apart than necessary,
   * by weakly asking everything to be at the origin
   */
  *createSquashingConstraints() {

    for (let { point } of this.points.values()) {

      yield new Kiwi.Constraint(
        this.getVariable(point, 0),
        Kiwi.Operator.Eq,
        0,
        Kiwi.Strength.weak
      );
  ...
  /**
   * Make sure each point stays at the correct height
   */
